  ...
  return (
    <main className="container section public-page-shell public-page-shell--packages">
      <section className="public-page-banner">
        <div className="section-heading package-page-head page-hero-copy public-page-head public-page-banner-copy">
        ...
        <div className="package-editorial-band public-page-band public-page-banner-side">
